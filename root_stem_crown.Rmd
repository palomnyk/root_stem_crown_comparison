...
lmMetadata = function(testingData, label){
  ...
  # print(dFrame)
  # print(as.factor(as.character(metadata[as.character(dFrame$metaNames[i]),])))
  # print(metadata[as.character(dFrame$metaNames[i]),])
  # print(unlist(testingData[dFrame$index[i],]))
  # print(as.character(dFrame$metaNames[i]))
